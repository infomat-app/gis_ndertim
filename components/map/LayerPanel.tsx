...
export default function LayerPanel({
  ...
  return (
    <>
      ...
      <aside
        className={open
          ? 'flex flex-col bg-s1 border-r border-b1 shrink-0 w-72 fixed inset-y-0 left-0 z-50 md:relative md:inset-auto md:z-auto'
          : 'hidden md:flex md:flex-col bg-s1 border-r border-b1 shrink-0 md:w-10'
        }
      >
        {/* Header */}
                  ...
                  >
                    ...
                    {!isRenam && (
                      <button
                        ...
                        className="shrink-0 p-1 rounded hover:bg-b2 text-txt3 hover:text-txt transition-colors opacity-100 md:opacity-0 md:group-hover:opacity-100"
                        title="Veprime"
                      >
                        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
